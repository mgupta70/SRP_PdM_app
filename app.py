...
uploaded_file = st.file_uploader("Upload a .pkl file 📥. In case you dont have data, request it by emailing to me or Russell Genet (Russell.Genet@srpnet.com) of SRP.", type='pkl', accept_multiple_files=False)
