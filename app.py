...
uploaded_file = st.file_uploader("Upload a .pkl file. Else download data by clicking [here](https://drive.google.com/file/d/1xBhSBicqOKHgc-g32y9cp1Hz1CJvqQku/view?usp=drive_link) 📥", type='pkl', accept_multiple_files=False)
